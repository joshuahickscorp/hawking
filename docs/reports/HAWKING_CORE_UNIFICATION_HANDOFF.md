...
- The review-fix commit follows these three. It connects the native contract to
  the real full-sequence ratio-zero caller, closes validation gaps, hardens exact
  artifact selection and records the final limitations.
