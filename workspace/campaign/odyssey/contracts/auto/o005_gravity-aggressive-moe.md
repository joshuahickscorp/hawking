# DELEGATION — O005 AGGRESSIVE GRAVITY (q4-g64-experts; gate profile: MLX/Metal)
...
Write receipts/odyssey-i/O005_GRAVITY_q4-g64-experts.json (schema odyssey.patient.gravity.v1): spec, stored/active bpw, complete_bpw,
...
## ACCEPTANCE
- receipts/odyssey-i/O005_GRAVITY_q4-g64-experts.json exists with stored_bpw < 16, complete_bpw, nominal_bits, candidate_class,
...
VERIFY receipts/odyssey-i/O005_GRAVITY_q4-g64-experts.json by running the unfenced command below; must pass, exit 0.
python3 tools/odyssey_patient_runner.py --oxx O005 --weights /Users/scammermike/.cache/huggingface/hub/models--Qwen--Qwen3-30B-A3B/snapshots/ad44e777bcd18fa416d9da3bd8f70d33ebb85d39 --runtime mlx --out receipts/odyssey-i/O005_GRAVITY_q4-g64-experts.json --packet workspace/campaign/odyssey/patients/O005/ODYSSEY_PATIENT_O005.json --gravity q4-g64-experts
