# DELEGATION — O005 FRONTIER NOVELTY / compression
...
## BUILD
Write `receipts/odyssey-i/O005_NOVELTY_compression.json` (schema hawking.odyssey.novelty_lane_report.v1) with one or more
...
## ACCEPTANCE
- `receipts/odyssey-i/O005_NOVELTY_compression.json` exists, schema hawking.odyssey.novelty_lane_report.v1, each proposal has
