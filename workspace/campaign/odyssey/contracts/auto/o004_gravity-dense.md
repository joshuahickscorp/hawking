...
Write receipts/odyssey-i/O004_GRAVITY_q4-g64.json (schema odyssey.patient.gravity.v1): spec, stored/active bpw, complete_bpw,
...
## ACCEPTANCE
- receipts/odyssey-i/O004_GRAVITY_q4-g64.json exists with stored_bpw < 16, complete_bpw, nominal_bits, candidate_class,
