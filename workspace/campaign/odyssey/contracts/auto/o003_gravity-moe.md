...
Write receipts/odyssey-i/O003_GRAVITY_q3-g32-experts.json (schema odyssey.patient.gravity.v1): spec, stored/active bpw, complete_bpw,
...
## ACCEPTANCE
- receipts/odyssey-i/O003_GRAVITY_q3-g32-experts.json exists with stored_bpw < 16, complete_bpw, nominal_bits, candidate_class,
