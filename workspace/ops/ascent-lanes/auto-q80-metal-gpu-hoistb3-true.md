...
---
# LANE: auto-q80-metal-gpu-hoistb3-true
...
Source lane: `auto-q80-dsv4f-host-expert-slab-20260816-022954` (status SHIPPED)

    metal GPU 284622000 ns (DIRTY_ENGINEERING, hoistB3 true GPU timestamps); remaining host exclusive 289363167 ns, of which expert mmap is now 86-91 ms. Attn prefetch full work is still ~406-414 ms but is off the critical path.
