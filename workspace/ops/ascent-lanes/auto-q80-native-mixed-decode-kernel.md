...
---
# LANE: auto-q80-native-mixed-decode-kernel
...
Source lane: `q80-pack-20260816-002155` (status SHIPPED)

    native mixed decode kernel does not exist (kernel lane). Until that kernel runs, generation cannot be measured; no ns/token for this artifact.
