...
---
# LANE: auto-q80-fused-layer-routed-gpu
...
Source lane: `auto-q80-routed-mixed-expert-wave-20260816-115627` (status SHIPPED)

    fused layer+routed GPU 132353275 ns/token (B6; wall 136610004). Token is GPU-bound. Occupancy/geometry of the 10-expert mixed wave inside the shared CB; leftover 1372 named CBs + 28 last-routed + host greedy ~5 ms/token.
