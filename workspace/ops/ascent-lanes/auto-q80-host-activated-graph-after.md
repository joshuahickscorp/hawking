...
---
# LANE: auto-q80-host-activated-graph-after
...
Source lane: `auto-q80-native-mixed-decode-kernel-20260816-063253` (status SHIPPED)

    host-activated token graph after GEMV occupancy (12460 host activations + 13804 CBs/generate); residual ~380e6 ns/token of the 445e6 decode wall (DIRTY_ENGINEERING). GPU matvec is now 64e6 ns/forward.
