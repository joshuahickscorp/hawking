...
---
# LANE: auto-q80-pack-real-sub-catalog
...
Source lane: `q80-recalibrate-capability-bar-20260816-023440` (status PARTIAL)

    pack a real sub-0.655 catalog (hgravs gate/up + binary down + ne4) and generate it; analog is cosine-matched, not byte-identical; second prompt already collapses; streamed RSS cap 16 GiB killed the long session (17229037568 > 17179869184)
