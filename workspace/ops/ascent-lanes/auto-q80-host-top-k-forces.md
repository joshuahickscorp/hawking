...
---
# LANE: auto-q80-host-top-k-forces
...
Source lane: `auto-q80-deltanet-still-opens-cbs-20260816-081051` (status SHIPPED)

    host top-k forces 1008 DeltaNet prefix waits (GPU-side floor 8.9 ms/forward); inside each CB qkvz-class GPU is larger at 16.5 ms/forward. Device-side top-k is the remaining way to drop the 1008 waits. Expert table still simdgroup.
