...
---
# LANE: auto-q80-first-touch-expert-payload
...
Source lane: `q80-runtime-residency-20260816-003204` (status SHIPPED)

    first-touch expert payload upload (catalog read + SHA-256 + MTLBuffer copy), 90–245 ms/token on late tokens; after that DeltaNet is ~134 ms/token of the dirty run
