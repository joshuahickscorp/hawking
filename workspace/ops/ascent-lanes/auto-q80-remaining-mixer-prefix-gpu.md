...
---
# LANE: auto-q80-remaining-mixer-prefix-gpu
...
Source lane: `auto-q80-fused-layer-cb-gpu-20260816-111016` (status SHIPPED)

    remaining mixer+prefix GPU after geo+vi (named Q4 qkvz/out/shared/router + leftover activations), 16731384 ns/forward (clean SB1/SB3 16.73–16.94 ms; then simdgroup expert-table suffix 11.56–11.59 ms; fused CB 28.48–28.50 ms/forward)
