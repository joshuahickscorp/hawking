...
---
# LANE: auto-dsv4f-metal-gpu-true-gpu
...
Source lane: `dsv-attn-weight-io-20260816-010759` (status SHIPPED)

    metal.gpu 393375000 ns/token median (true GPU timestamps, 129 CBs). Next host-streamed candidate is shared expert + moe_control I/O (~254 ms summed on B2/B3, same per-layer reuse shape).
