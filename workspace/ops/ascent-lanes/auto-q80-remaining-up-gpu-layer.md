...
---
# LANE: auto-q80-remaining-up-gpu-layer
...
Source lane: `auto-q80-up-proj-fused-binary-20260816-033715` (status PARTIAL)

    remaining up GPU is 27584 ns/layer (2758 ns/expert) inside the 10-expert pack; binary-only floor is still 6666 ns unbatched. Isolated host wall is 218000 ns/dispatch and will dominate if the live path still submits one CB per expert.
