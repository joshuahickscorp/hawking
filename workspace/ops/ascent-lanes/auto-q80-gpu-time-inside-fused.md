...
---
# LANE: auto-q80-gpu-time-inside-fused
...
Source lane: `auto-q80-host-activated-graph-after-20260816-083630` (status SHIPPED)

    GPU time inside the 97 fused CBs/forward (routed mixed wave + Q8 mixer/shared/lm_head + device DeltaNet/GQA), 132998524 ns/token (DIRTY_ENGINEERING); host exclusive is now 6-12e6 ns/token
