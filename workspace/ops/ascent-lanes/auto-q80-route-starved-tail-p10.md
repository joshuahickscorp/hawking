...
---
# LANE: auto-q80-route-starved-tail-p10
...
Source lane: `q80-capture-coverage-20260816-003209` (status PARTIAL)

    route-starved tail — p10 = 34 rows (measured); 221 never-routed pairs; ~119k tokens to put p10 at rank 160, ~171k to put the median at 2048. The 25k capture also has no on-disk post-SwiGLU X.
