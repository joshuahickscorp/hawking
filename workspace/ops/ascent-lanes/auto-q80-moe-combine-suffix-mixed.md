...
---
# LANE: auto-q80-moe-combine-suffix-mixed
...
Source lane: `auto-q80-expert-first-touch-upload-20260816-053859` (status SHIPPED)

    moe_combine suffix mixed CB, 48038376 ns/token (GPU 19494170 ns/token); then DeltaNet prefix 42319387 ns/token
