...
---
# LANE: auto-q80-serial-down-proj-two
...
Source lane: `auto-q80-remaining-up-gpu-layer-20260816-074007` (status PARTIAL)

    serial down_proj two-dispatch (10 experts, 2-TG each) plus host SwiGLU readback; moe_routed after the pack is 6.442 ms/layer (309 ms/token at 48 layers). Isolated row8 up is 33 µs. hgravs_factor_dispatches stayed 26880. Pack rebuild memcpy still fires every wave (1344/generate) because top-10 changes.
