...
---
# LANE: auto-q80-deltanet-still-opens-cbs
...
Source lane: `auto-q80-isolated-mib-qmv-launch-20260816-055927` (status SHIPPED)

    DeltaNet still opens 1008 CBs/generate; wait−GPU gap is ~362 µs/CB, matching the isolated CB floor of 328916 ns. Kernel work is already 12 µs isolated / 4.4 µs batched. Expert table remains simdgroup. Do not re-pay global topology collapse.
