...
Change addressing layout (blocked / organ-contiguous / Morton) without changing the codec. The bucket is named addressing.

---
# LANE: auto-qwen38-weight-addressing-try13
...
Source lane: `qwen38-synthesis-addressing_layout_not_codec` (status SYNTHESIZED)
