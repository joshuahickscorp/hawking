...
---
# LANE: auto-q80-live-still-38e9-host
...
Source lane: `auto-q80-weight-decode-alu-after-20260816-055422` (status SHIPPED)

    live token still ~1.38e9 ns DIRTY host-dominated; remaining packed GPU is up_proj (10 serial binary+csr dispatches in the same CB) and down_proj hgravs01 (historically 259000 ns/organ, not re-swept). Isolated sharex floor is 28958 ns / 10-gate wave.
