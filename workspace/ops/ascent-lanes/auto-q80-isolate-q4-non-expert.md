...
---
# LANE: auto-q80-isolate-q4-non-expert
...
Source lane: `auto-q80-pack-real-sub-catalog-20260816-070919` (status SHIPPED)

    isolate q4 non-expert vs expert codecs as the collapse cause (analog never applied ne4); token-time limiter on a coherent generate remains moe_routed at 1.612e10 ns of the first token
