...
---
# LANE: auto-q80-host-moe-table-build
...
Source lane: `q80-component-simdgroup-20260816-010759` (status SHIPPED)

    host moe_table_build ~197000000 ns/token (A1 5.530 s / 28 forwards; B1 spiked to 11.24 s). Mixer occupancy is no longer the complete-token wall.
