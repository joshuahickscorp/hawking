...
---
# LANE: auto-q80-moe-combine-mixed-suffix
...
Source lane: `auto-q80-moe-table-build-host-20260816-080035` (status SHIPPED)

    moe_combine mixed suffix CB, 25949893 ns/token (B3; suffix GPU 12.55 ms, host Instant 25.95 ms)
