...
Collapse 129 RMSNorm launches (input + post + final) by folding them into the following work or sharing one persistent encoder. Not GEMV fusion.

---
# LANE: auto-qwen38-normalization
...
Source lane: `qwen38-synthesis-collapse_rmsnorm_launches` (status SYNTHESIZED)

    normalization 2367415 ns
