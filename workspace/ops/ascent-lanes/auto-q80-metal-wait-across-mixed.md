...
---
# LANE: auto-q80-metal-wait-across-mixed
...
Source lane: `auto-q80-q80-wall-host-compact-20260816-085150` (status SHIPPED)

    metal.wait 56748377–62966919 ns (DIRTY_ENGINEERING) across 98 mixed prefix+suffix CBs; true GPU 32482136–36226130 ns (42% busy). B2 identity: suffix 26.1 ms, prefix_deltanet 24.9 ms, moe_table_build 18.1 ms, prefix_gqa 6.8 ms.
