...
---
# LANE: auto-q80-col-mixer-out-proj
...
Source lane: `auto-q80-remaining-gpu-matvec-after-20260816-101852` (status SHIPPED)

    4096-col mixer out_proj still serial (simd fails 2e-5 at 2^-15); leftover named GPU 180040005 ns/token (DIRTY_ENGINEERING), of which ~153 ms is out_proj; host gap 349300040 ns on the same Q8-occupancy decode token
