...
---
# LANE: auto-q80-mixed-deltanet-prefix-wait
...
Source lane: `auto-q80-mixed-suffix-cb-moe-20260816-074515` (status SHIPPED)

    mixed DeltaNet prefix wait 34742314 ns (B3; that wait now also drains leftover suffix GPU 12.6 ms/token) then host moe_table_build 18204641 ns; suffix GPU arithmetic still 12.6 ms/token (vecgroup remains opt-in)
