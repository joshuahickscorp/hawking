...
---
# LANE: auto-dsv4f-determined-teacher-x-capture
...
Source lane: `dsv-resident-gravity-20260816-001744` (status PARTIAL)

    determined teacher-X capture/fit (existing X underdetermined). 21846-token fill × 3.323e9 ns ≈ 7.26e13 ns streamed forward (DIRTY_ENGINEERING, ~20 h). After a hypothetical resident pack the already-measured wall is metal.gpu 2082931000 ns/token (act_quant), not I/O.
