...
---
# LANE: auto-q80-isolated-mib-qmv-launch
...
Source lane: `matvec-mlx-reference-20260816-022115` (status SHIPPED)

    isolated 0.59 MiB qmv launch/occupancy (~250-310 us HOST_WALL; Hawking kernel 210 us GPU). Not DRAM rows. Qwen-sized organs already at ~180 GB/s on MLX — remaining gap to the 560-647 GB/s probe is ~3x, not 230x.
