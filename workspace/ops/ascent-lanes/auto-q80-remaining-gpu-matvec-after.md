...
---
# LANE: auto-q80-remaining-gpu-matvec-after
...
Source lane: `auto-q80-path-serial-down-proj-20260816-082614` (status SHIPPED)

    remaining GPU matvec 747244293 ns/token after down is now 5015602 ns (DIRTY_ENGINEERING). Q8 mixer/shared/lm_head plus still-serial token-path gate/up (`q80_binary_group_matvec` + CSR). Occupancy kernels for those organs exist and are not wired; quieter isolated floors are gate 6875 ns, up 11416 ns. Host gap on the same forwards is 298709623 ns.
