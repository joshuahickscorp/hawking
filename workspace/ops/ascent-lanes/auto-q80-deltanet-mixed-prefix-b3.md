...
---
# LANE: auto-q80-deltanet-mixed-prefix-b3
...
Source lane: `auto-q80-cbs-dispatches-gpu-idle-20260816-065853` (status SHIPPED)

    DeltaNet mixed-prefix 42301739 ns (B3; component still vecgroup_x64), then moe_table_build 29736357 ns; remaining GPU idle 73.5-76.1 ms (sync-bound). 98 CBs / 1155 dispatches unchanged.
