...
---
# LANE: auto-q80-q4-organ-still-s
...
Source lane: `matvec-occupancy-230x-20260816-015752` (status SHIPPED)

    Q4 organ still 11.0 µs / 50.45 GB/s (10.9× below the 550 GB/s control); 1440×11 µs = 15.90 ms, 1.99× the 8 ms expert budget. Host compact_expert_slab_pack (~281 ms) remains the larger full-token term.
