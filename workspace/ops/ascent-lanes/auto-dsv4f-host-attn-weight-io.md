...
---
# LANE: auto-dsv4f-host-attn-weight-io
...
Source lane: `dsv-integrate-graph-20260816-005613` (status SHIPPED)

    host.attn_weight_io_prefetch 252900000 ns (pair1_nocopy); leftover host.expert_slab_io 239426001 ns is now mmap/bind of 40 learned experts, not slab memcpy; host.memcpy 232630000 ns sits beside it. GPU 302157000 ns is not the wall.
