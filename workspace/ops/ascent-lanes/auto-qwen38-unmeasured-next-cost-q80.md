...
---
# LANE: auto-qwen38-unmeasured-next-cost-q80
...
Source lane: `qwen38-reuse-matrix-20260816-021330` (status PARTIAL)

    unmeasured — next cost is the Q80 dispatch locks (DeltaNet 32×128×128, GQA 16/2/θ=5e6) plus pack-time fuse of split in_proj_qkv/z/a/b; no Q38 token-ns exists yet. Git commit of this receipt is blocked in-sandbox.
