...
---
# LANE: auto-q80-all-mixed-generate-untested
...
Source lane: `q80-coherence-probe-20260816-002153` (status SHIPPED)

    all-48 mixed generate (untested). Secondary: L0 structured error (mix/null 2.06) and typical-organ capture (p50 258 rows vs dim 2048/512).
