...
- This moves 13.618 GB at 97.6% of the 411.51 GB/s "unique-once decode ceiling"
- The bottleneck is in G024 (some stage), specifically mlp addr_probe at 12,719,208 ns which is 82.9% of mlp GEMV at 15,325,458 ns
- Four "genome levers" didn't help
- Already refuted: fusing tiny kernels, cross-token cache reuse, N sessions sharing one weight body

The key insight they're asking for:
- 13.618 GB moved at 97.6% of 411.51 GB/s ceiling
- 13.618 GB / 411.51 GB/s = 33.09 μs = 33,090 ns... wait, let me recalculate
- 13.618 GB / 411.51 GB/s = 0.03309 s = 33,090 μs... no that's wrong
- 13.618 / 411.51 = 0.03309 s = 33,090 μs = 33,090,000 ns... that doesn't match 21,293,103 ns

Wait, let me re-read. "moves 13.618 GB at 97.6% of the 411.51 GB/s unique-once decode ceiling"

So the actual bandwidth achieved is 97.6% of 411.51 GB/s = 401.53 GB/s
Time = 13.618 GB / 401.53 GB/s = 0.03392 s = 33,920 μs = 33,920,000 ns

But the measured time is 21,293,103 ns. That doesn't match. Let me re-read.

Actually wait - maybe the 13.618 GB is the total weight data, and the 21,293,103 ns is the time. Let me check: 13.618 GB / 21,293,103 ns = 13.618e9 bytes / 21.293e-6 s = 639.5 GB/s. That's higher than the 411.51 GB/s ceiling, which doesn't make sense.

Hmm, maybe I'm misreading the units. Let me re-read: "moves 13.618 GB at 97.6% of the 411.51 GB/s unique-once decode ceiling"

If 97.6% of 411.51 = 401.53 GB/s, then time = 13.618 / 401.53 = 0.0339 s = 33.9 ms. But the measured is 21.29 ms.

Or maybe the 13.618 GB is the theoretical minimum (unique-once) and the actual bytes moved is higher? No, it says "at 97.6% of the ceiling" which implies it's already near the bandwidth limit.

Actually, I think the point is: the weight_addressing cost

---
# LANE: auto-q80-weight-addressing-g024-this-try2
...
Source lane: `q38-genome-kv-residency-20260816-184208` (status SHIPPED)

    weight_addressing 21293103 ns (G024; this-run mlp addr_probe 12719208 ns = 82.9% of mlp GEMV 15325458 ns). The four genome levers did not move it.
