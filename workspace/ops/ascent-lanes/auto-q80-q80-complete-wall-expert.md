...
---
# LANE: auto-q80-q80-complete-wall-expert
...
Source lane: `auto-q80-q4-organ-still-s-20260816-060431` (status SHIPPED)

    Q80 complete-token wall 206–498 ms DIRTY (median 287 ms). Expert-table GPU is now ~6.4 ms/generate and is not the wall. Host metal.wait / attention / first-touch remain.
