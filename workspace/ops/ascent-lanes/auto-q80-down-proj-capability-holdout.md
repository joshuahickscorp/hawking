...
---
# LANE: auto-q80-down-proj-capability-holdout
...
Source lane: `q80-subbit-capability-curve-20260816-020047` (status PARTIAL)

    down_proj capability, holdout cosine 0.768 vs bar 0.8604 (not a token-ns figure; Q4 path remains ~5.59e8 ns/token on TOKEN_NS_Q80)
