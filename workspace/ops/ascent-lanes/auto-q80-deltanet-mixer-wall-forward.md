...
---
# LANE: auto-q80-deltanet-mixer-wall-forward
...
Source lane: `auto-q80-mixed-up-proj-expert-20260816-054914` (status SHIPPED)

    DeltaNet mixer wall 461000000 ns/forward (B3 deltanet 12.9278 s / 28 forwards, DIRTY_ENGINEERING). Serial gate (2-TG) and serial down_proj remain unwired on this path. Isolated remaining up_proj is 13500 ns vs binary-only 11709 ns.
