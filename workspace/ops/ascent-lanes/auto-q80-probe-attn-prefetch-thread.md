...
---
# LANE: auto-q80-probe-attn-prefetch-thread
...
Source lane: `auto-dsv4f-host-expert-slab-io-20260816-025622` (status PARTIAL)

    probe.attn_prefetch_thread (next-layer attn I/O on the GPU-idle joint wall) 267869705 ns/token; after that leftover expert-only I/O ~155 ms and Metal GPU 274317000–280577000 ns across 134 CBs
