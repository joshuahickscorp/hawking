...
---
# LANE: auto-q80-moe-table-build-d2
...
Source lane: `auto-q80-deltanet-prefix-cb-mixed-20260816-090713` (status SHIPPED)

    moe_table_build 17993066 ns (D2), then unmixed DeltaNet mixer GPU ~14.8 ms/forward and suffix GPU 12296098 ns; split GPU idle still 32263864 ns (sync-bound)
