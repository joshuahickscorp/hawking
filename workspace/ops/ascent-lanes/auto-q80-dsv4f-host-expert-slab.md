...
---
# LANE: auto-q80-dsv4f-host-expert-slab
...
Source lane: `joint-token-ns-20260816-010044` (status SHIPPED)

    DSV4F host.expert_slab_io 415126416 ns (DIRTY_ENGINEERING), then the 275026398 ns unattributed residual inside metal host_wall, then metal GPU 399023000 ns across 137 CBs. Q80 host.compact_expert_slab_pack 280819429 ns serial, then metal.wait 273658315 ns (contains 231968522 ns GPU).
