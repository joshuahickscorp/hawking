...
---
# LANE: auto-q80-routed-mixed-wave-serial
...
Source lane: `auto-q80-all-mixed-generate-untested-20260816-032208` (status SHIPPED)

    routed mixed wave (serial binary+rice+hgravs + host silu/readback), 197650527 ns GPU/forward on B6
