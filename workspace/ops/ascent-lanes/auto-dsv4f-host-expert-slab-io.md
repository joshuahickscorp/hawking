...
---
# LANE: auto-dsv4f-host-expert-slab-io
...
Source lane: `dsv-host-wall-20260816-001740` (status SHIPPED)

    host.expert_slab_io 415126416 ns/token (GPU-idle streamed top-6 expert read+fill). After residency deletes that: Metal GPU 399023000 ns/token across 137 CBs; surviving host MHC+decode ~50 ms.
