...
---
# LANE: auto-dsv4f-host-exclusive-inter-cb
...
Source lane: `dsv-cb-collapse-20260816-001742` (status SHIPPED)

    host exclusive / inter-CB GPU idle from streaming weight IO + host MHC — 870578334 ns host exclusive and 1036353092 ns inter-CB device gap on pair 3B (73% of GPU span idle). Largest remaining GPU family is attn at 201280000 ns. Reader/IO is dsv-host-wall.
