...
---
# LANE: auto-q80-path-serial-down-proj
...
Source lane: `auto-q80-up-proj-binary-decode-20260816-061439` (status SHIPPED)

    token-path serial down_proj (`q80_hgravs01_factor_matvec` two-dispatch), 261291 ns (DIRTY_ENGINEERING, quieter A from q80-decode-throughput; simd3 occupancy exists and is not wired). Remaining up_proj binary floor is 11416 ns DIRTY.
