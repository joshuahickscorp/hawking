...
---
# LANE: auto-q80-host-top-expert-address
...
Source lane: `q80-deltanet-gqa2-20260816-003206` (status PARTIAL)

    host top-10 + expert address-table bind, 157820565 ns/token (A1 host_work; moe_table_build 5.92 s over 28 forwards)
