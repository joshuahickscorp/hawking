...
---
# LANE: auto-q80-moe-table-build-host
...
Source lane: `auto-q80-deltanet-mixer-d3-deltanet-20260816-054407` (status SHIPPED)

    moe_table_build host_address_table, 30161607 ns/token (S2 geo+split decode identity, DIRTY_ENGINEERING); remaining mixed DeltaNet prefix wall 51.7-56.0 ms/forward (GPU 22.9-23.2 ms)
