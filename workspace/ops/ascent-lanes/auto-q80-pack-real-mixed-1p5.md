...
---
# LANE: auto-q80-pack-real-mixed-1p5
...
Source lane: `auto-q80-isolate-q4-non-expert-20260816-091221` (status SHIPPED)

    pack a real mixed-1p5-ne4 catalog (incumbent experts + q4 non-expert, ~1.324 BPW) or a crushed-expert catalog that keeps DeltaNet at q8; do not put q4 on linear_attn while experts are r16/r40+binary-down. Coherent 1p5 limiter remains moe_routed at 9.44e9 ns session (pair median; first-token wall 22.8 s)
