...
---
# LANE: auto-q80-deltanet-mixer-d3-deltanet
...
Source lane: `q80-expert-first-touch-20260816-010044` (status SHIPPED)

    DeltaNet mixer, 92600000 ns/token (D3 deltanet 2.594 s / 28 steps)
