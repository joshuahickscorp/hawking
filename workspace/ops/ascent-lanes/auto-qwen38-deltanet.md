...
Fuse DeltaNet activation tails (gated_rmsnorm, ba_to_decay, rearrange) into the vi kernel or one encoder. Not GEMV fusion.

---
# LANE: auto-qwen38-deltanet
...
Source lane: `qwen38-synthesis-fuse-deltanet-activation-tails` (status SYNTHESIZED)
