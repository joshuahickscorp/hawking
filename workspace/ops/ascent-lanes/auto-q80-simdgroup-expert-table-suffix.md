...
---
# LANE: auto-q80-simdgroup-expert-table-suffix
...
Source lane: `auto-q80-remaining-mixer-prefix-gpu-20260816-115119` (status SHIPPED)

    simdgroup expert-table suffix, 11546515 ns/forward (clean PB 11.55–11.61 ms); remaining mixer+prefix is 10.78–10.88 ms, of which mixer activations are 5.92–6.15 ms. Fused CB 22.44–22.53 ms/forward.
