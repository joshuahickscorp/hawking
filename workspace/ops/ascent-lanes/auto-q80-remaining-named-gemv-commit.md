...
---
# LANE: auto-q80-remaining-named-gemv-commit
...
Source lane: `auto-q80-remaining-sequential-named-gemv-20260816-102359` (status SHIPPED)

    remaining named GEMV commit_and_wait on 2716 CBs (qkvz+ba / q+k+v / mixer-suffix / 28 lm_head); warm B named_wait 46003828 ns/forward (DIRTY_ENGINEERING). Host DeltaNet conv/recurrent and GQA attn still separate the same-input projections from this chain. Secondary: warm routed wave 31813105 ns/forward.
