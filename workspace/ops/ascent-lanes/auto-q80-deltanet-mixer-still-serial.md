...
---
# LANE: auto-q80-deltanet-mixer-still-serial
...
Source lane: `auto-q80-moe-routed-serial-gate-20260816-095822` (status SHIPPED)

    DeltaNet mixer still serial Q8 on this tree, 367000000 ns/forward (B3 deltanet 10.2784 s / 28); leftover moe_routed is ensure/first-touch 104000000 ns/forward (2.9171 s / 28). 4096-col out_proj occupancy still fails 2e-5.
