...
---
# LANE: auto-q80-mixed-suffix-cb-moe
...
Source lane: `auto-q80-host-moe-table-build-20260816-032723` (status SHIPPED)

    mixed suffix CB moe_combine 24000000 ns/token on B1 (35.7%) plus DeltaNet prefix 23390000 ns/token (34.8%); suffix GPUEnd-GPUStart 348 ms / 28 vs suffix wait 673 ms; 98 CBs / 1155 dispatches. moe_table_build is 12.1 ms on that run.
