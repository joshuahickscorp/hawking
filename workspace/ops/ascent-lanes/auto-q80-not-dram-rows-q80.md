...
---
# LANE: auto-q80-not-dram-rows-q80
...
Source lane: `dram-row-locality-20260816-013210` (status SHIPPED)

    not DRAM rows. Q80 host moe_table_build ~246 ms; DSV4F attn_weight_io_prefetch ~253 ms. GPU packed matvecs sit at ~2.5 GB/s against a 560–647 GB/s read-reduce on the same box.
