...
---
# LANE: auto-q80-fused-layer-cb-gpu
...
Source lane: `auto-q80-host-top-k-forces-20260816-100836` (status SHIPPED)

    fused 48-layer CB GPU arithmetic (qkvz + shared + simdgroup expert table), 38750000 ns/forward (1046 ms GPU / 27 nowait forwards; wait−GPU leftover ~3.1 ms/forward). First token of a generate still pays 36 DeltaNet prefix waits. Expert table still simdgroup.
