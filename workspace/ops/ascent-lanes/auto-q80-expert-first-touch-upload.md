...
---
# LANE: auto-q80-expert-first-touch-upload
...
Source lane: `q80-device-topk-20260816-010759` (status PARTIAL)

    expert first-touch upload (q80-expert-first-touch), 241542041 ns/token on B1; after that, mixer+expert GPU is ~132 ms/token
