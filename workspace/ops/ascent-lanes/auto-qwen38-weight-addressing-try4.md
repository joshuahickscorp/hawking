...
- Bottleneck: weight_addressing at 21,293,103 ns (60.44% of total)
- It moves 13.618 GB at 97.6% of the 411.51 GB/s "unique-once decode ceiling"
- So the weight addressing is already hitting 97.6% of the theoretical maximum bandwidth for unique-once decode
...
The key insight: weight_addressing moves 13.618 GB at 97.6% of 411.51 GB/s. Let me verify: 13.618 GB / 411.51 GB/s = 0.03309 s = 33.09 ms. But the measured time is 21.293 ms. Wait, that doesn't add up. Let me re-read.

Actually wait - 13.618 GB at 97.6% of 411.51 GB/s. So the effective bandwidth is 0.976 * 411.51 = 401.63 GB/s. Time = 13.618 / 401.63 = 0.0339 s = 33.9 ms. But the measured is 21.293 ms. Hmm, that's inconsistent.

Wait, maybe I'm misreading. Let me re-read: "moves 13.618 GB at 97.6% of the 411.51 GB/s unique-once decode ceiling"

So the ceiling is 411.51 GB/s. At 97.6% of that, the effective rate is 401.63 GB/s. Time to move 13.618 GB at 401.63 GB/s = 33.9 ms. But the measured bottleneck is 21.293 ms.

Hmm, that's a discrepancy. Unless the 13.618 GB is the total bytes addressed but the 21.293 ms is the time, and 97.6% refers to something else. Or maybe the 13.618 GB is the total weight set and the 21.293 ms is the time to address it, and 97.6% is the fraction of the ceiling being utilized.

Actually, let me reconsider. Maybe the "unique-once decode ceiling" means: if every byte is read exactly once (no reuse), the maximum throughput is 411.51 GB/s. At 97.6% of that, you get 401.63 GB/s. 13.618 GB / 401.63 GB/s = 33.9 ms. But measured is 21.293 ms.

OR: maybe 13.618 GB is the total weight set, and the 21.293 ms is the time, giving an effective rate of 13.618/0.021293 = 639.6 GB/s. That's higher

---
# LANE: auto-qwen38-weight-addressing-try4
...
Source lane: `genesis-bytes-20260816-204512` (status UNKNOWN)
