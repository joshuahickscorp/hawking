...
---
# LANE: auto-q80-leftover-deltanet-host-instant
...
Source lane: `auto-q80-deltanet-mixer-packed-1p5-20260816-122206` (status SHIPPED)

    leftover DeltaNet host Instant after named-Q4 occupancy, 3.24e9 ns session (B p3); isolated mixer GPU floor 0.234 ms/forward. Secondary: ensure_expert first-touch 2.95e9 ns.
