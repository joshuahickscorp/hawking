...
---
# LANE: auto-q80-moe-routed-serial-gate
...
Source lane: `auto-q80-deltanet-mixer-wall-forward-20260816-080544` (status SHIPPED)

    moe_routed serial gate (2-TG) + two-dispatch up + two-dispatch down, 336000000 ns/forward (B3 9.4013 s / 28); remaining mixer out_proj 143000000 ns/forward still serial 4096-col Q8
