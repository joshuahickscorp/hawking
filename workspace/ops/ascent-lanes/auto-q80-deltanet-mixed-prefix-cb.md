...
---
# LANE: auto-q80-deltanet-mixed-prefix-cb
...
Source lane: `q80-integrate-graph-20260816-012855` (status SHIPPED)

    DeltaNet mixed prefix CB (mixer+shared+router+wait), 79081238 ns/token on D3 identity (DIRTY_ENGINEERING)
