...
---
# LANE: auto-dsv4f-host-exclusive-not-this
...
Source lane: `dsv-occupancy-geometry-20260816-010044` (status SHIPPED)

    host exclusive ~625-680 ms/token (not this lane). Inside attention after this win: wq_b ~267-319 us/layer already at 32768 threads, then wo_a ~233 us, wo_b ~190 us, sparse_pos0 ~131 us on 64 threads (~5.6 ms/token). Layer p50 1.19 ms. Realized 92 GB/s of ~750.
