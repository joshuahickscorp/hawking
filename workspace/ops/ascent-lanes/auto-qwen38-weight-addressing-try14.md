...
Move address generation / bind work across the host-GPU cut, without fusing kernels into the following GEMV.

---
# LANE: auto-qwen38-weight-addressing-try14
...
Source lane: `qwen38-synthesis-host_gpu_partition_of_addressing` (status SYNTHESIZED)
