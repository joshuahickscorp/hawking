...
---
# LANE: auto-q80-remaining-sequential-named-gemv
...
Source lane: `auto-q80-named-gemv-commit-and-20260816-083123` (status SHIPPED)

    remaining sequential named GEMV commit_and_wait (5404 CBs: out_proj / o_proj / shared down / lm_head); warm B named_wait 1.86 s/generate ≈ 66560000 ns/forward (DIRTY_ENGINEERING). Secondary: warm moe_routed 1.24 s ≈ 44 ms/forward. Do not retry encoder-collapse.
