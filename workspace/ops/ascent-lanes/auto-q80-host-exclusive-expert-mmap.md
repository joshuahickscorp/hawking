...
---
# LANE: auto-q80-host-exclusive-expert-mmap
...
Source lane: `auto-q80-metal-gpu-hoistb3-true-20260816-065339` (status SHIPPED)

    host exclusive 307-318 ms (expert mmap still 72-80 ms) plus route wait ~68 ms; metal.gpu 339-357 ms DIRTY but 62% of the device span is idle
