...
---
# LANE: auto-q80-up-proj-binary-decode
...
Source lane: `q80-lowrank-algebra-20260816-015251` (status SHIPPED)

    up_proj binary decode/occupancy, 17250 ns (DIRTY_ENGINEERING, quieter up_b median); ~45% of the remaining 38 us/expert, ~15 GB/s, not DRAM-bound and not reconstruct-W-bound
