...
---
# LANE: auto-q80-q80-wall-host-compact
...
Source lane: `auto-q80-down-proj-capability-holdout-20260816-064315` (status PARTIAL)

    Q80 token wall host.compact_expert_slab_pack + metal.wait, 559171655 ns/token DIRTY_ENGINEERING (Q4 vehicle). down_proj holdout is explained; q3g32 is +0.030 under 1.5 and does not close 0.8604 on 101 pairs.
