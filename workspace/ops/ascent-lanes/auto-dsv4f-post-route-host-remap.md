...
---
# LANE: auto-dsv4f-post-route-host-remap
...
Source lane: `dsv-expert-20260816-003212` (status SHIPPED)

    post-route host remap of 6 expert chunks + next-layer attn views, 262400000 ns (iso_nocopy2 host.expert_slab_io; joint with attn prefetch 274.0 ms). GPU arithmetic 374150000 ns.
