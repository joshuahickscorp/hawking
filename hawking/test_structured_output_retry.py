...
Measured from a live mission receipt (.hawking/receipts/8039ee5a-*.json):
...
from hawking.backends import CompletionResult, SchemaViolation, StructuredOutputExhausted
