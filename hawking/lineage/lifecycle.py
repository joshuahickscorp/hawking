...
from .bus import ResearchBus
from .canon import require_sha256, utc_now
...
from .identity import GenesisInstance, Invoker, file_sha256
from .promotion import REQUIRED_PROTECTED_TESTS, evaluate_promotion
from .state import LineageError, LineageState
from .transfer import pack_state, parent_research_payload, payload_checksum
from hawking.qwen38_protected_run_verifier import verify_qwen38_capture
from hawking.receipts import seal, verify
...
def _current_tokenizer(current: GenesisInstance, *, repo: Path) -> Path:
    ...
    try:
        from hawking.genesis_resident import discover_tokenizer
...
def _directive_bindings() -> list[dict[str, Any]]:
    from hawking.genesis_contract import contract_provenance
