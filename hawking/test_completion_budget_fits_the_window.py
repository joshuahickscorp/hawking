...
from hawking.engine import _CTX_ESTIMATE_MARGIN, _MAX_TOKENS_FLOOR, Engine
...
def test_a_roomy_prompt_still_gets_a_generous_budget():
    ...
    """
    from hawking.engine import _MAX_TOKENS_CEILING
...
def test_the_margin_scales_with_the_prompt():
    ...
    """
    from hawking.engine import _CTX_ESTIMATE_ERROR, _MAX_TOKENS_CEILING
