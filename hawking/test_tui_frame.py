...
from hawking.events import Event, EventBus
from hawking.tui import TUI, display_width, frame_width
...
def test_a_raising_turn_keeps_the_session_alive():
    from hawking.engine import EngineError
    seen = []
...
def test_a_large_paste_is_echoed_as_a_receipt_not_the_text():
    from hawking.tui import summarize_paste, _PASTE_ECHO_LIMIT
