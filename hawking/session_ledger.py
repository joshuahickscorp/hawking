...
It deliberately reuses `hawking.landing.IntegrationVerifier`'s own git
...
# One dict, one place, each number justified. HAWKING_LEDGER_FILES /
# HAWKING_LEDGER_LINES / HAWKING_LEDGER_MINUTES override at runtime.
_ENV_PREFIX = "HAWKING_LEDGER_"
...
def discover_repo_root(workspace: PathLike) -> Path:
    ...
    rest of HAWKING, which only ever runs inside this repo, but it is wrong
