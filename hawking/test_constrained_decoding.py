...
.hawking/receipts/10464271-*.json: "Unterminated string starting at: line 3
...
from hawking.engine import HAWKING_RESULT_SCHEMA
...
class TestNativeWireProtocolCannotCarryConstrainedDecoding(unittest.TestCase):
    def test_response_format_and_grammar_never_reach_the_resident(self):
        ...
        payload = {
            ...
            "response_format": {"type": "json_schema", "json_schema": HAWKING_RESULT_SCHEMA},
            "grammar": "root ::= object",
            "max_tokens": 512,
        }
...
class TestDeterministicTruncationRepair(unittest.TestCase):
    def test_short_answer_can_omit_mode_specific_empty_arrays(self):
        contract = StructuredOutputContract(
            ...
            instruction=schema_instruction(HAWKING_RESULT_SCHEMA),
        )
    ...
    def test_trailing_unterminated_string_is_closed_without_a_retry(self):
        ...
        contract = StructuredOutputContract(
            schema=HAWKING_RESULT_SCHEMA, instruction=schema_instruction(HAWKING_RESULT_SCHEMA)
        )
