...
session: we never report a pipe capture as a PTY.
    ...
    from hawking.perception.terminal import capture, probe
"""
    ...
    *,
    ...
    if not probed.get("ok"):
        ...
        wake = {
            ...
            "predicate": (
                "production AST Call of hawking.perception.terminal.capture from the "
    ...
    receipt = tool_receipt(
        ...
        limitations=[],
        verifier="hawking.perception.terminal.capture",
