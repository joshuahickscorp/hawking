...
This replaces the one thing hawking/perception_adapter.py needed from the foreign
...
nothing in hawking ever asked it to: call_perception only ever constructed a host in
