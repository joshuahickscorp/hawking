...
support it. It does not decompile and does not treat an absent target as an
empty success.

    from hawking.perception.file_eye import observe
"""
...
def verify_image_geometry(path: str | Path, *, timeout: float = 20.0) -> dict[str, Any]:
    ...
    The directive's perception priority is "exact tool-grounded verification". Parsing
