...
GOAL = (
    "Operate. "
    "G001 make verification self-hosting. Verified by hawking/test_goal_verifier_synthesis.py "
    "G002 attribute the control-plane gap. Verified by hawking/test_hawking_overhead.py "
    "G003 prove self mutation end to end. Verified by hawking/test_self_mutation_e2e.py "
    "G004 put the context compiler on the runtime path. Verified by hawking/test_context_compiler_runtime.py"
)
