...
Runnable two ways:
    ...
    python3 -m pytest hawking/test_command_registry.py -q
    python3 hawking/test_command_registry.py
"""
from __future__ import annotations

from hawking.commands import COMMANDS, command_names, handler_name, help_text
...
def test_authority_uses_the_tool_registry_vocabulary():
    ...
    from hawking.tool_registry import MUTATION_CLASSES
...
def test_anatomy_is_registered_and_refuses_without_crashing(tmp_path):
    """G036: HAWKING owns OI. A body with no weights is a named refusal, exit-path 2."""
    from hawking.commands import handler_name
