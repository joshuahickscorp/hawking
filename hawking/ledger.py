"""Obligation ledger and completion governor for HAWKING AgentOS.
...
call must not be caught-and-ignored:
    ...
    from hawking.ledger import Ledger, GoalNotMetError, NO_PROGRESS_THRESHOLD
