...
from hawking.persist import json_compatible_copy as _copy


SCHEMA = "hawking.physical_graph.v1"
SCORING_SCHEMA = "hawking.physical_graph_scoring.v1"
REPATRIATION_SCHEMA = "hawking.physical_graph_repatriation.v1"
...
MEGA_KERNEL_SCHEMA = "hawking.physical_graph.mega_kernel.v1"
MEGA_KERNEL_STAGES = (
    "LOAD",
    "DECODE",
    "ROUTE",
    ...
    *,
    ...
    if "LayoutTransform" in primitives:
        ...
        representation["layout_algebra"] = {
            "schema": "hawking.physical_graph_layout_algebra.v1",
    ...
    if "StationaryRepresentation" in primitives:
        representation["stationarity"] = {
            "schema": "hawking.physical_graph_stationarity.v1",
            "candidate_operands": [
                "weights",
                "basis",
                "codebook",
