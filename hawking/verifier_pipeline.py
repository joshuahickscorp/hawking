...
Deliberately NOT replicated (belong to a workflow orchestrator HAWKING does
...
Agent-role mapping (superagent agentType -> HAWKING agent_role):
...
"""
    ...
    count = 0
    match = re.search(r"__HAWKING_ASSERT_COUNT__=(\d+)", blob)
    if match:
