...
class TUI:
    ...
    def render_header(self) -> str:
        ...
        return "\n".join(
            [_rule("┌", "┐", w, "HAWKING")] + _rows(info, w) + _rows(bank_line, w)
        )
    ...
    def _mission_running(self) -> bool:
        ...
        Reads .hawking/mission/state.json directly -- the exact shape
