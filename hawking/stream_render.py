"""One shared formatter for HAWKING's live event stream.
...
watcher (hawking/agentos/resident.py:watch_resident) could not reuse any of it and
...
from hawking.tui (that keeps this module trivially embeddable in a read-only
...
# --- duplicated (not imported) from hawking.tui, kept byte-for-byte in sync ---
