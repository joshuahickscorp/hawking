"""Tests for the HAWKING-callable Apple Neural Engine probe lab.
...
not evidence the shell-only lab is now HAWKING-callable.
"""
...
from hawking import forbidden_fruit as ff
...
def test_run_forbidden_fruit_lab_runs_the_real_fixture_and_reports_observed_placement(tmp_path):
    ...
    This is the HAWKING-callable surface the mission asked for. It does not
