...
The campaign asks HAWKING to be a scientist: read the ledger, choose a specimen, measure
...
from hawking.engine import Engine, is_accepted_work, is_accepted_measurement
