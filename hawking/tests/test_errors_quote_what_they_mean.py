...
from hawking.engine import _python_syntax_violation, _rejected_excerpt

TARGET = "hawking/tool_registry.py"
# Keep the fixture anchored to the current source indentation.  A four-space
# substring also occurs inside the live eight-space line and would splice a
# syntactically invalid hybrid while falsely appearing to be a unique anchor.
