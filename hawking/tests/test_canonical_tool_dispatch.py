...
from hawking.tool_registry import ToolContext, _doctor_query, _gravity_experiment
...
def test_gravity_execute_dispatches_one_bounded_representation_runner(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "hawking.agentos.flash_representation_experiment.run_flash_representation_experiment",
        run,
    )
