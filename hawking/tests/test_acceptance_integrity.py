...
from hawking.engine import Engine, EngineError, NoOpMutation
from hawking.events import EventBus
from hawking.mutation import MutationError, _apply_insert, _apply_replace
...
class TestAcceptanceIntegrity(unittest.TestCase):
    ...
    def test_empty_tests_rejects_ungrounded_mutation_before_write(self):
        self._write("a.py", "x = 1\n")
        ...
        self.assertEqual(
            (self.engine.root / "a.py").read_text(encoding="utf-8"), "x = 1\n"
        )
