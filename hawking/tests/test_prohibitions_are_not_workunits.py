...
Measured, `.hawking/mission/state.json` for the tools/hawking_metric.py goal: FIFTEEN
...
GOAL = (
    "In tools/hawking_metric.py, decode_seconds returns None even when every call is "
    "instrumented. Fix tools/hawking_metric.py so that all four tests in "
    "tools/test_hawking_metric_never_zeroes_unknown.py pass. "
    "Do not edit tools/test_hawking_metric_never_zeroes_unknown.py. "
...
def test_the_prohibition_survives_as_an_invariant():
    ...
    assert "Do not edit tools/test_hawking_metric_never_zeroes_unknown.py" in inv
