...
from hawking.backends import OpenAICompatibleBackend
from hawking.controller import Controller
from hawking.flash_next import PINNED_REVISION, REPO_ID, flash_next_profile
from hawking.models import resolve_model
from hawking.providers import CapabilityContract, ResidentProfile, RoleRouter
from hawking.runtime_iface import classify_backend, model_semantics_for
from hawking.tool_registry import ToolSpec, WORKSPACE_WRITE, default_tool_registry
...
class AgentOSGeneralTest(unittest.TestCase):
        ...
        try:
            with tempfile.TemporaryDirectory() as tmp:
                ...
                try:
                    ...
                    session_files = list((root / ".hawking" / "sessions").glob("*.json"))
    ...
    def test_agentos_mission_checkpoint_and_restart_recovery(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((root / ".hawking" / "mission" / "state.json").is_file())
    ...
    def test_flash_science_organ_graph_is_explicit_and_non_additive_for_norms(self):
        from hawking.agentos.flash_science import _organ_graph
