...
class TestAuthorityIsStructural(unittest.TestCase):
    ...
    def test_no_builder_door_takes_a_free_form_command(self):
        ...
        """
        from hawking.chat_tools import _declared_schema, build_registry
...
class TestTheContractItselfIsExercised(unittest.TestCase):
    ...
    def test_the_read_only_contract_renders(self):
        from hawking.chat_tools import system_block
    ...
    def test_every_offered_door_appears_with_its_shape(self):
        from hawking.chat_tools import argument_shape, builder_menu, system_block
        for write in (False, True):
...
class TestToolsAreNeverSilentlyDropped(unittest.TestCase):
    ...
    def test_tools_requested_but_undeclarable_raises_rather_than_omitting(self):
        from hawking.hawking_native import HawkingNativeError
        connector = self._connector()
...
class TestSessionInheritsSurfaceAuthority(unittest.TestCase):
    ...
    def test_working_set_shows_write_when_the_session_has_it(self):
        from hawking.chat_state import ChatSession, working_set
        from tempfile import TemporaryDirectory
