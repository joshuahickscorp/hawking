...
from hawking.report_compiler import (
...
class TestReportCompactionSemantics(unittest.TestCase):
    ...
    def test_medium_keeps_decision_critical(self):
        raw = (
            "FINDING: buffer overflow in hawking/cli.py:12\n"
            "- claim: overflow is reachable from parse_args\n"
            "$ python3 -m pytest hawking/tests/test_cli.py -q\n"
            "error: boom\n"
        ...
        c = _compile(
            ...
            extra={
                ...
                "verifier_inputs": ["python3 -m pytest hawking/tests/test_cli.py -q"],
            },
        )
    ...
    def test_large_collapses_and_stays_bounded(self):
        signal = "FINDING: buffer overflow in hawking/cli.py:12\n"
    ...
    def test_canary_material_change_changes_digest(self):
        ...
        base = "FINDING: buffer overflow in hawking/cli.py:12\n" + pad
        extra = {
            "status": {"state": "done", "exit_code": 0},
        ...
        d_find = payload_dumps(_compile(
            "FINDING: use after free in hawking/cli.py:12\n" + pad,
            extra=extra,
        ))
...
class TestProvenanceAddressability(unittest.TestCase):
    def test_raw_report_path_reads_back_through_compact(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            body = "FINDING: buffer overflow in hawking/cli.py:12\n"
    ...
    def test_compact_path_resolves_and_raw_is_readable(self):
        from hawking.grok_bridge import GrokBridge
