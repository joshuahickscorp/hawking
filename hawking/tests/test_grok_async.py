...
from hawking.grok_bridge import GrokBridge, GrokRunError
from hawking.report_compiler import compile_backend_report
...
class TestGrokWaitPolls(unittest.TestCase):
    ...
    def test_compact_report_does_not_dump_raw_trace(self):
        ...
        raw.write_text(
            ...
            "error: boom\n"
            "$ python3 -m pytest hawking/tests -q\n"
            "hawking/commands.py changed\n",
            encoding="utf-8",
        )
        receipt = {
            "task_id": task_id,
