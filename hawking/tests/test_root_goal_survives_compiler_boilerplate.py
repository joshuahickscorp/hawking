...
from hawking.goal import ROOT_GOAL_OMITTED, _excise_root_goal, root_is_the_whole_objective

ROOT = (
    "Add a total_lines key to the whole-file return dict of _read_file in "
    "hawking/tool_registry.py, giving the line count of the whole file, so that "
    "hawking/tests/test_read_file_reports_total_lines.py passes."
)
BOILERPLATE = (
    " obligations=G001 " + ROOT + " Relevant files: hawking/tool_registry.py, "
    "hawking/tests/test_read_file_reports_total_lines.py"
)
