...
The PERCEPTION priority list in the overnight directive names "documents/images" and
...
from hawking.perception.file_eye import _jpeg, _jpeg_geometry, verify_image_geometry
...
def test_the_cross_check_actually_binds(tmp_path, monkeypatch):
    ...
    if not shutil.which("sips"):
        pytest.skip("sips absent")
    import hawking.perception.file_eye as fe
