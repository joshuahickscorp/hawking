...
goal, and excising it there removes the entire instruction. The worker received
    ...
    OBJECTIVE: obligations=G001 [ROOT_GOAL_OMITTED] Relevant files: hawking/resources.py
...
ROOT = (
    "Read hawking/resources.py and explain in two sentences why pid_is_alive "
