...
This is the gate that decides whether HAWKING's survey output can be trusted
...
from hawking.odyssey_census import (EXECUTION_CLASSES, FAMILIES, REQUIRED, Unit,
...
class TestAnAcceptedUnitIsRecordedAsHcliAuthored(unittest.TestCase):
    def test_the_receipt_says_who_wrote_it(self):
        with TemporaryDirectory() as tmp:
            ...
            self.assertEqual(rec["author"], "hawking",
                             "a receipt HAWKING produced must not be attributable to the supervisor")
