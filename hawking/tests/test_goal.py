...
from hawking.engine import Engine, EngineError, _SYSTEM_PROMPT
...
_ULTRAGOAL_CANDIDATES = (
    REPO / "docs/ultragoals/HAWKING_SUPER_AGENT_OS.md",
    Path("/Users/scammermike/Downloads/hawking-copy/docs/ultragoals/HAWKING_SUPER_AGENT_OS.md"),
)
...
class TestWorkerPacketCompiler(unittest.TestCase):
    ...
    def test_compile_worker_context_rejects_goal_header(self):
        from hawking.goal import WorkerPacket, compile_worker_context
    ...
    def test_knowledge_steers_are_excluded_constraints_kept(self):
        from hawking.context_budget import PacketBudgetError
        from hawking.goal import compile_worker_context
        from hawking.steering import SteerEvent
    ...
    def test_scars_are_bounded_not_an_archive(self):
        ...
        from hawking.goal import MAX_SCAR_LINES, compile_worker_context
    ...
    def test_execute_fallback_is_hard_error(self):
        from hawking.executors import dispatch_workunit
    ...
    def test_consult_uses_packet_prompt_not_root_goal(self):
        from hawking.executors import consult_worker
        from hawking.goal import compile_worker_context
