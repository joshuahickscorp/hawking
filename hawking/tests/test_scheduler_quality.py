...
from hawking.resources import ResourceLimits
...
from hawking.scheduler import Scheduler
from hawking.workunit import WorkUnit, content_identity
    ...
    def test_identity_survives_in_process_restart_and_replan(self):
        with tempfile.TemporaryDirectory() as tmp:
            original = _wu(
                ...
                role="impl",
                description="wire the mutation lock",
                verifier="pytest -q hawking/tests/test_scheduler_quality.py",
            )
            child = _wu(
                "G002",
                role="validate",
