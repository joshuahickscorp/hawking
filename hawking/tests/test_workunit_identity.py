...
from hawking import dag_store as dag_store_mod
...
from hawking.workunit import WorkUnit, assign_ready, identify_ready, is_ready
...
class TestContentIdentity(unittest.TestCase):
    def test_same_content_twice_is_idempotent(self):
        ...
        if hasattr(a, "verifier"):
            a.verifier = "pytest -q hawking/tests/test_workunit_identity.py"
            b.verifier = "pytest -q hawking/tests/test_workunit_identity.py"
    ...
    def test_lineage_cannot_exceed_cap_across_a_real_restart(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            script = (
                ...
                ""
                "from hawking.dag_store import DagStore\n"
                "from hawking import workunit as wm\n"
