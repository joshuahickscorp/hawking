"""Negative control: Hawking perception must not grow a network client."""
from __future__ import annotations

import ast
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1] / "perception"
...
def test_no_network_imports_in_hawking_perception():
    offenders: list[str] = []
