...
from hawking.chat_state import CONTEXT_SHARE
from hawking.context_budget import resolve
from hawking.serve import _context_window, _prompt_window

MODEL = "hawking/hawking-native.sealed-3.14.json"
