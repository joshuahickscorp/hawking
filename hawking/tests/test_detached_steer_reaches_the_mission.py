...
injects a steer, detaches, and HAWKING continues. Measured 2026-09-05, before this
fix:
...
def test_a_detached_steer_lands_in_the_missions_queue_with_provenance(tmp_path):
    ...
    target = tmp_path / ".hawking" / "steering" / "S-9.json"
