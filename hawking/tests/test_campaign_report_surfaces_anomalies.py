...
from hawking.campaign_report import Cycle, _find_anomalies, arcs, gather, render
...
class TestTheReportSurfacesWhatTheLogHid(unittest.TestCase):
    def test_a_red_on_a_passing_test_is_reported(self):
        got = _anoms("RED: hawking/tests/test_x.py — 5 passed in 0.06s (returncode 0)",
    ...
    def test_a_real_red_is_not_reported_as_an_anomaly(self):
        ...
        got = _anoms("RED: hawking/tests/test_x.py — 1 failed in 0.900s",
