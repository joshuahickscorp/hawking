...
S036 s3/s4: HAWKING perceives "I can inspect source", not "I have ripgrep". S036
...
from hawking.capabilities import (
    UNOWNED_DOMAINS,
    Capability,
    Rung,
    capabilities,
...
class TestSurfaceIsProbed(unittest.TestCase):
    ...
    def test_report_remains_the_last_unowned_domain(self):
        # REPORT has two real paths (receipts + hawking report) but no single owned
