"""HAWKING could measure and had nowhere to put the answer.
...
This is the door. It closes an autonomy gap with a name: HAWKING could not close a WorkUnit
...
def test_the_tool_exists_and_is_not_read_only():
    ...
    assert "odyssey.record_measurement" in names, (
        "HAWKING can read the ledger and never write it, so no round can close")
