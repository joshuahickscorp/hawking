...
from hawking.agentos import flash_router_selection as router_selection
from hawking.agentos import flash_transform_parity as transform
...
SCHEMA = "hawking.agentos.flash_noetic_router_representation_ab.v1"
    ...
    *,
    ...
    try:
        ...
        report.update({
            ...
            "noetic_ir": {"schema": "hawking.noetic.ir.v1", "semantic_type": "NoeticIR", "operations": ["read_pinned_router_source_reference", "derive_in_memory_router_representations", "execute_source_and_candidate_router_selection", "compare_ebpw_and_source_top_k_overlap", "retain_native_compatibility_boundary"], "complete_model": False, "candidate_bodies_persisted": False},
