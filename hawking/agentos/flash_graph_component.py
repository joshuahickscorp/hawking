...
SCHEMA = "hawking.agentos.flash_noetic_graph_component.v1"
PHYSICAL_GRAPH_SCHEMA = "hawking.physical_graph.v1"
DESCRIPTOR_SCHEMA = "hawking.noetic.representation_descriptor.v1"
...
def _validate(
    ...
    if loader.get("schema") != "hawking.agentos.flash_loader_roundtrip.v1":
    ...
    if transform.get("schema") != "hawking.agentos.flash_transform_parity.v1":
