...
from hawking.persist import (
    ...
    json_compatible_copy as _copy,
)
from hawking.physical_graph import compile_physical_graph


SCHEMA = "hawking.agentos.flash_noetic_component_campaign.v1"
...
def _validate_component(
    ...
    if body.get("schema") != "hawking.agentos.flash_noetic_component_body.v1":
