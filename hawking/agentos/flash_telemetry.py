...
def _telemetry_bench(
    ...
    *,
    ...
    return {
        ...
        "recorded_by": "hawking.agentos.flash_telemetry.emit_flash_telemetry",
...
def emit_flash_telemetry(
    ...
    *,
    ...
    ledger = {
        "schema": "hawking.agentos.flash_gpu_work_ledger.v1",
    ...
    critical = {
        "schema": "hawking.agentos.flash_token_critical_path.v1",
    ...
    capability = {
        "schema": "hawking.agentos.cuda_capability_graph.v1",
