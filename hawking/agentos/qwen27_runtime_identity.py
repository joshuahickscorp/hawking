...
the current HAWKING profile.  Missing historical files are recorded as UNKNOWN;
...
IDENTITY_SCHEMA = "hawking.agentos.qwen27_historical_runtime_identity.v1"
DIFF_SCHEMA = "hawking.agentos.qwen27_runtime_diff.v1"
...
def _current_identity(repo: Path, profile_path: Path) -> Dict[str, Any]:
    from hawking.agentos.qwen38_fusion_audit import _selected_graph
