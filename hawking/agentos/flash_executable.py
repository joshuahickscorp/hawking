...
from hawking.agentos.flash_telemetry import emit_flash_telemetry
...
SCHEMA = "hawking.agentos.flash_next_noetic_executable.v1"
EBPW_SCHEMA = "hawking.agentos.flash_ebpw_budget.v1"
TOKEN_NS_SCHEMA = "hawking.agentos.flash_token_ns_budget.v1"
DERIVED = "[D]"
NOT_MEASURED = "NOT_MEASURED"
DEFAULT_SCIENCE = "FLASH_NEXT_PRE_RUNTIME_SCIENCE.json"
...
def run_flash_executable_scaffold(
    *,
    ...
    science_path = (
        Path(science_receipt).expanduser().resolve()
        if science_receipt
        else preferred_flash_science_receipt(repo)
    )
