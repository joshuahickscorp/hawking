...
from hawking.agentos import flash_component_body as component_body
...
def run_flash_matrix_component_body(
    *,
    ...
    body_path = Path(body).expanduser().resolve() if body else repo / ".hawking" / "flash-component" / DEFAULT_BODY_NAME
