...
"""
from hawking.engine import validation_failure_message as msg
...
def test_pytest_failure_detail_reaches_the_message():
    ...
    stdout = (
        "============================= test session starts ====================\n"
        "collected 1 item\n\n"
        "hawking/tests/test_x.py F                                          [100%]\n\n"
        "=================================== FAILURES =========================\n"
        "______________ TestProjectNameEmpty.test_create_empty_name ___________\n"
        "hawking/tests/test_x.py:6: in test_create_empty_name\n"
        "    with self.assertRaises(ValueError):\n"
        "E   AssertionError: ValueError not raised\n"
        "=========================== short test summary info ==================\n"
        "FAILED hawking/tests/test_x.py::TestProjectNameEmpty::test_create_empty_name\n"
    )
    out = msg({"ok": False, "checks": [
        {"kind": "test", "reason": "TEST_FAILED", "exit_code": 1, "runner": "pytest",
         "requested": "python hawking/tests/test_x.py", "stdout": stdout, "stderr": ""}]})
