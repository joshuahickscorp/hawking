...
One useful mutation originates in HAWKING, is verified, and crosses the integration boundary.
...
def test_the_mutation_originated_in_hawking_not_a_human():
    doc = _load()
    assert doc.get("origin") == "hawking_resident", (
