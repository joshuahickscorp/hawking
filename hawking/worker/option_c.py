...
CANDIDATE_SCHEMA = "hawking.worker.option_c.candidate.v1"
REVIEW_SCHEMA = "hawking.worker.option_c.review.v1"
DECISION_SCHEMA = "hawking.worker.option_c.decision.v1"
