"""HAWKING-callable entry to the Apple Neural Engine probe lab.
...
surface so HAWKING code can discover devices, run the existing compiled
...
DEFAULT_EMIT = REPO / "receipts" / "headless" / "HAWKING_FORBIDDEN_FRUIT_LAB.json"
SCHEMA = "hawking.forbidden_fruit_lab.v1"
...
def run_forbidden_fruit_lab(
    *,
    ...
    """Minimum HAWKING-callable ANE lab surface: discover, place, time, pair, receipt.
