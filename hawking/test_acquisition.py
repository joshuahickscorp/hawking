"""hawking/acquisition.py: HAWKING's acquisition decision surface.
...
Runnable two ways:
    ...
    python3 -m pytest hawking/test_acquisition.py -q
    python3 hawking/test_acquisition.py
"""
...
from hawking import acquisition
