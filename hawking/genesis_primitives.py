#!/usr/bin/env python3
"""Hawking callable primitives — the G012 embryo (steer S001/S004, plan W0.T10).
...
existing SUBSTRATE + Hawking machine state — no new ontology, no reimplementation.
  ...
  substrate_append(record)   -> typed record onto receipts/hawking/GENESIS_SUBSTRATE.jsonl
...
SUBSTRATE = REPO / "receipts" / "hawking" / "GENESIS_SUBSTRATE.jsonl"
...
def _machine_state():
    from hawking import machine_state
