...
independent. Runnable two ways:
    ...
    python3 -m pytest hawking/test_paste_cache.py -q
    python3 hawking/test_paste_cache.py
"""
...
from hawking.paste_cache import PasteCache, PasteNotFound, PasteRef
...
def test_a_sub_second_burst_still_orders_newest_first(monkeypatch):
    ...
    """
    import hawking.paste_cache as paste_cache
