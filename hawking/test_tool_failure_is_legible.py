...
Measured on a live run: the model listed `hawking`, called `fs.read` on it, and got
`FileNotFoundError: /Users/.../hawking`. The path was correct; it was a directory.
...
def test_fs_list_works_with_no_arguments(ctx):
    ...
    """
    from hawking.tool_registry import _list_files
