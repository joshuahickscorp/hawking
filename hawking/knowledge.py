"""Durable, bounded prior knowledge for long-lived HAWKING workspaces.
...
KNOWLEDGE_SCHEMA = "hawking.workspace_knowledge.v1"
LEGACY_KNOWLEDGE_SCHEMAS = frozenset({"hcli.workspace_knowledge.v1"})
...
class KnowledgeStore:
    ...
    def __init__(
        ...
        *,
        ...
        configured = archive_root or os.environ.get("HAWKING_CONTEXT_ARCHIVE_ROOT")
        if configured:
    ...
    def _read_unlocked(self) -> Dict[str, Any]:
        ...
        if schema not in (None, KNOWLEDGE_SCHEMA, *LEGACY_KNOWLEDGE_SCHEMAS):
