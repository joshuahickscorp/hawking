...
import hawking.machine as machine
from hawking.resident import memory_decision
...
# Pin the ceiling rather than inherit HAWKING_SWAP_CEILING_GIB from whatever ran
