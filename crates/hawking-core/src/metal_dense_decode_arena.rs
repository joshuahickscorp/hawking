...
mod arena_imp {
    ...
    impl DenseDecodeArena {
        ...
        pub fn new(ctx: &MetalContext, n_layers: usize, n_heads: usize, n_kv_heads: usize, head_dim: usize, hidden: usize, intermediate: usize, vocab_size: usize, max_seq: usize) -> Self {
            ...
            Self::new_with_batch(ctx, n_layers, n_heads, n_kv_heads, head_dim, hidden, intermediate, vocab_size, max_seq, 8)
        }
