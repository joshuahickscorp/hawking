...
//! `QwenDense::forward_token` (`crates/hawking-core/src/model_qwen_dense.rs`
...
impl<P: KvEvictionPolicy> KvWorkingSet<P> {
    ...
    pub fn on_token_appended(&mut self, _current_pos: usize, _layer_scores: &[AttentionScores]) -> Vec<EvictionPlan> {
        todo!(
...
impl Default for KvWorkingSet<LosslessPolicy> {
    ...
    fn default() -> Self {
        Self::new(LosslessPolicy, WorkingSetBudget::new(usize::MAX), WorkingSetMode::Lossless)
    }
}
