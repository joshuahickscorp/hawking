...
pub use imp::{
    ...
    rwkv7_decay_act_tcb, rwkv7_gemv_f32_off_tcb, rwkv7_gemv_f32_xoff_yoff_tcb, rwkv7_kk_kmix_multiseq_tcb, rwkv7_kk_kmix_tcb, rwkv7_layernorm_multiseq_tcb, rwkv7_layernorm_tcb,
    rwkv7_lora_grouped_gemv_tcb, rwkv7_lora_mid_act_tcb, rwkv7_relu_sq_inplace_tcb, rwkv7_shift_writeback_multiseq_tcb, rwkv7_sigmoid_bias_multiseq_tcb, rwkv7_sigmoid_bias_tcb,
    rwkv7_sigmoid_inplace_tcb, rwkv7_tanh_inplace_tcb, rwkv7_token_shift_lerp_multiseq_tcb, rwkv7_token_shift_lerp_tcb, rwkv7_value_residual_mix_multiseq_tcb, rwkv7_value_residual_mix_tcb,
    rwkv7_wa_prep_tcb, rwkv7_wkv_decode_multiseq_tcb, rwkv7_wkv_decode_tcb, RwkvDecodeArena,
};
...
mod imp {
    ...
    impl RwkvDecodeArena {
        ...
        pub fn new(
            ...
            Self::new_with_batch(ctx, n_layer, n_embd, n_ff, head_size, head_count, vocab_size, decay_lora, iclr_lora, value_res_lora, gate_lora, 1)
        }
        ...
        pub fn reset_state(&self) {
            let s_per_layer = self.head_count * self.head_size * self.head_size;
            for (buf, elems) in
                [(&self.wkv_state, self.batch * self.n_layer * s_per_layer), (&self.att_shift, self.batch * self.n_layer * self.n_embd), (&self.ffn_shift, self.batch * self.n_layer * self.n_embd)]
            {
        ...
        pub fn reset_slot(&self, slot: usize) {
            ...
            unsafe {
                let base = (self.wkv_state.contents() as *mut f32).add(slot * self.n_layer * s_per_layer);
    ...
    fn dispatch_n(tcb: &mut TokenCommandBuffer<'_>, kernel: &str, n: u32, encode: impl FnOnce(&metal::ComputeCommandEncoderRef)) -> Result<()> {
    ...
    #[allow(clippy::too_many_arguments)]
    pub fn rwkv7_gemv_f32_off_tcb(tcb: &mut TokenCommandBuffer<'_>, w: &PinnedBuffer, rows: usize, cols: usize, x: &PinnedBuffer, x_off_bytes: usize, out: &PinnedBuffer) -> Result<()> {
        ...
        tcb.dispatch_threads("gemv_f32_attn", (rows_u32 * LN_TG, 1, 1), (LN_TG, 1, 1), |enc| {
    ...
    pub fn rwkv7_lora_grouped_gemv_tcb(
        ...
        tcb.dispatch_threads("rwkv7_lora_grouped_gemv", (total_u32 * LN_TG, 1, 1), (LN_TG, 1, 1), |enc| {
            enc.set_buffer(0, Some(w), 0);
    ...
    pub fn rwkv7_lora_mid_act_tcb(tcb: &mut TokenCommandBuffer<'_>, lo: &PinnedBuffer, w_end: usize, g_begin: usize, total: usize) -> Result<()> {
    ...
    pub fn rwkv7_tanh_inplace_tcb(tcb: &mut TokenCommandBuffer<'_>, x: &PinnedBuffer, n: usize) -> Result<()> {
    ...
    pub fn rwkv7_wa_prep_tcb(tcb: &mut TokenCommandBuffer<'_>, lora_up: &PinnedBuffer, a_off_bytes: usize, w0: &PinnedBuffer, w_out: &PinnedBuffer, a0: &PinnedBuffer, n: usize) -> Result<()> {
        let mut ab = KernelArgBuffer::new(tcb.ctx, &[ArgLayout::U32, ArgLayout::U32])?;
    ...
    pub fn rwkv7_add_into_layernorm_tcb(
        ...
        ab.set_f32(1, eps);
        tcb.dispatch_threads("rwkv7_add_into_layernorm", (LN_TG, 1, 1), (LN_TG, 1, 1), |enc| {
    ...
    pub fn rwkv7_decay_act_tcb(tcb: &mut TokenCommandBuffer<'_>, w_raw: &PinnedBuffer, w0: &PinnedBuffer, w: &PinnedBuffer, n: usize) -> Result<()> {
    ...
    pub fn rwkv7_sigmoid_bias_tcb(tcb: &mut TokenCommandBuffer<'_>, x: &PinnedBuffer, x_off_bytes: usize, bias: &PinnedBuffer, n: usize) -> Result<()> {
    ...
    pub fn rwkv7_sigmoid_inplace_tcb(tcb: &mut TokenCommandBuffer<'_>, x: &PinnedBuffer, n: usize) -> Result<()> {
    ...
    pub fn rwkv7_kk_kmix_tcb(
        ...
        ab.set_u32(0, hs);
        tcb.dispatch_threads("rwkv7_kk_kmix", (head_count as u32 * hs, 1, 1), (hs, 1, 1), |enc| {
    ...
    pub fn rwkv7_wkv_decode_tcb(
        ...
        let hs = head_size as u32;
        let shmem = (hs as u64) * std::mem::size_of::<f32>() as u64;
        let mut ab = KernelArgBuffer::new(tcb.ctx, &[ArgLayout::U32, ArgLayout::F32, ArgLayout::U32])?;
        ab.set_u32(0, hs);
        ab.set_f32(1, gn_eps);
        ab.set_u32(2, has_gate as u32);
        tcb.dispatch_threads("rwkv7_wkv_decode", (head_count as u32 * hs, 1, 1), (hs, 1, 1), |enc| {
    ...
    pub fn rwkv7_relu_sq_inplace_tcb(tcb: &mut TokenCommandBuffer<'_>, k: &PinnedBuffer, n: usize) -> Result<()> {
    ...
    pub fn rwkv7_add_into_tcb(tcb: &mut TokenCommandBuffer<'_>, a: &PinnedBuffer, b: &PinnedBuffer, out: &PinnedBuffer, n: usize) -> Result<()> {
    ...
    pub fn rwkv7_copy_tcb(tcb: &mut TokenCommandBuffer<'_>, src: &PinnedBuffer, dst: &PinnedBuffer, dst_off_bytes: usize, n: usize) -> Result<()> {
    ...
    pub fn rwkv7_token_shift_lerp_multiseq_tcb(
        ...
        let mut ab = KernelArgBuffer::new(tcb.ctx, &[ArgLayout::U32, ArgLayout::U32, ArgLayout::U32, ArgLayout::U32, ArgLayout::U32])?;
        ab.set_u32(0, n as u32);
        ab.set_u32(1, n_slots as u32);
    ...
    pub fn rwkv7_layernorm_multiseq_tcb(
        ...
        tcb.dispatch_threads("rwkv7_layernorm_multiseq", (batch as u32 * LN_TG, 1, 1), (LN_TG, 1, 1), |enc| {
            enc.set_buffer(0, Some(x), x_off_bytes as u64);
            enc.set_buffer(1, Some(weight), 0);
            enc.set_buffer(2, Some(bias), 0);
            enc.set_buffer(3, Some(out), out_off_bytes as u64);
    ...
    pub fn rwkv7_kk_kmix_multiseq_tcb(
        ...
        tcb.dispatch_threads("rwkv7_kk_kmix_multiseq", (batch as u32 * head_count as u32 * hs, 1, 1), (hs, 1, 1), |enc| {
            enc.set_buffer(0, Some(k), 0);
            enc.set_buffer(1, Some(k_k), 0);
            enc.set_buffer(2, Some(k_a), 0);
    ...
    pub fn rwkv7_wkv_decode_multiseq_tcb(
        ...
        let mut ab = KernelArgBuffer::new(tcb.ctx, &[ArgLayout::U32, ArgLayout::U32, ArgLayout::U32, ArgLayout::U32, ArgLayout::U32, ArgLayout::U32, ArgLayout::F32, ArgLayout::U32])?;
        ab.set_u32(0, hs);
        ab.set_u32(1, head_count as u32);
        ...
        // Grid: (B * head_count * hs); threadgroup = hs; tg index = b*head_count+head.
        tcb.dispatch_threads("rwkv7_wkv_decode_multiseq", (batch as u32 * head_count as u32 * hs, 1, 1), (hs, 1, 1), |enc| {
    ...
    pub fn rwkv7_decay_act_multiseq_tcb(tcb: &mut TokenCommandBuffer<'_>, w_raw: &PinnedBuffer, w0: &PinnedBuffer, w: &PinnedBuffer, n: usize, batch: usize) -> Result<()> {
        let total = (batch * n) as u32;
        let mut ab = KernelArgBuffer::new(tcb.ctx, &[ArgLayout::U32, ArgLayout::U32])?;
        ab.set_u32(0, n as u32);
        ab.set_u32(1, batch as u32);
    ...
    pub fn rwkv7_sigmoid_bias_multiseq_tcb(tcb: &mut TokenCommandBuffer<'_>, x: &PinnedBuffer, bias: &PinnedBuffer, n: usize, batch: usize) -> Result<()> {
        let total = (batch * n) as u32;
        let mut ab = KernelArgBuffer::new(tcb.ctx, &[ArgLayout::U32, ArgLayout::U32])?;
        ab.set_u32(0, n as u32);
        ab.set_u32(1, batch as u32);
    ...
    pub fn rwkv7_add_into_flat_tcb(tcb: &mut TokenCommandBuffer<'_>, a: &PinnedBuffer, b: &PinnedBuffer, out: &PinnedBuffer, total: usize) -> Result<()> {
