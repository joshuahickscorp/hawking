...
use crate::abi::{ConnectorAbi, FamilyId, WriteCapability};
...
/// permission gate and a write receipt (see [`crate::effects`]).
pub trait ConnectorWrite: ConnectorRead {
    ...
    fn prepare_write(
        ...
        store: &AccountStore,
        handle: &AccountHandle,
        kind: crate::effects::WriteKind,
        target: impl Into<String>,
        payload: impl Into<String>,
        summary: impl Into<String>,
    ) -> Result<crate::effects::ConnectorWriteProposal> {
        ...
        let effect = match kind {
            crate::effects::WriteKind::Delete => crate::abi::EffectClass::Delete,
            _ => crate::abi::EffectClass::Write,
        };
        let proposal = crate::effects::ConnectorWriteProposal {
