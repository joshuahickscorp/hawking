...
#[path = "compat_agents.rs"]
pub mod agents;
#[path = "compat_claude_md.rs"]
pub mod claude_md;
#[path = "compat_error.rs"]
pub mod error;
#[path = "compat_frontmatter.rs"]
pub mod frontmatter;
#[path = "compat_layout.rs"]
pub mod layout;
#[path = "compat_mcp.rs"]
pub mod mcp;
#[path = "compat_rules.rs"]
pub mod rules;
#[path = "compat_settings.rs"]
pub mod settings;
#[path = "compat_skills.rs"]
pub mod skills;
