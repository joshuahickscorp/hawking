...
const RECEIPT_ALLOWLIST: &[&str] = &[
    "research/evidence/glm52/GLM52_FLAGSHIP_ADAPTER_PARITY.json",
    "research/evidence/kimi-k26/KIMI_K26_ADAPTER_TWIN.json",
    "packs/hawking-adapters-extra.json",
    "research/evidence/fabric/FABRIC_BRIDGE_ARCHAEOLOGY.md",
];
