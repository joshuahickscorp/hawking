...
//!
//! Under DISMANTLE_QWEN_Q4K_LMHEAD=1, `forward_tokens_multiseq_logits` runs the
...
//!
//! Both tests set DISMANTLE_QWEN_Q4K_LMHEAD=1 BEFORE load (the full-vocab Q4_K
...
//!   cargo test --release -p dismantle-core --test multiseq_q4k_lmhead_parity \
