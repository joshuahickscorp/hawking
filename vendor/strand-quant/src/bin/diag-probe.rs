...
const ST: &str = "/Users/scammermike/Downloads/strand/scratch/model-safetensors-fp16.safetensors";

fn bf16_to_f32(bits: u16) -> f32 {
    f32::from_bits((bits as u32) << 16)
}

fn read_bf16(path: &str, name: &str) -> Vec<f32> {
    ...
    let nums: Vec<usize> = rest[b1 + 1..b2]
        .split(',')
...
fn main() {
    let t0 = Instant::now();
    let gt = read_bf16(ST, "model.layers.23.mlp.down_proj.weight");
