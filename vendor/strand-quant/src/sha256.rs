...
mod tests {
    ...
    fn nist_two_block() {
        ...
        assert_eq!(hex(&d), "248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1");
    }
    ...
    fn exact_block_boundary() {
        let msg = vec![b'a'; 64];
        let d = sha256(&msg);
        assert_eq!(hex(&d), "ffe054fe7ae0cb6dc65c3af9b61d5209f439851db43d0ba5997337df154668eb");
    }

    #[test]
    fn first8_of_abc_matches_digest_prefix() {
        let d = sha256(b"abc");
        let mut first8 = [0u8; 8];
        first8.copy_from_slice(&d[0..8]);
        assert_eq!(first8, [0xba, 0x78, 0x16, 0xbf, 0x8f, 0x01, 0xcf, 0xea]);
    }
}
