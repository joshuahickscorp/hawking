...
fn main() {
    ...
    let shapes: &[(&str, u32, u32)] = &[("attn_o 3584^2", 3584, 3584), ("ffn_up 3584x18944", 3584, 18944), ("ffn_down 18944x3584", 18944, 3584)];

    println!("{:<22} {:>9} {:>8} {:>7} {:>9} {:>7}  {}", "shape", "GPU us", "GB/s", "%peak", "B/weight", "ops/B", "verdict");
    println!("{}", "-".repeat(82));
    ...
    for &(name, rows, cols) in shapes {
        ...
        for r in 0..rows as u64 {
            for b in 0..bpr as u64 {
                ...
                tbl.push(BlockEntry { bit_offset: bit_off as u32, init_state: 0, scale_q: 1 << 16, eff: [1 << 16; 8], n: 256, d: 1, _pad: 0 });
            }
        }
        ...
        println!("{name:<22} {:>9.1} {achieved_gbs:>8.1} {pct_peak:>6.0}% {b_per_weight:>9.3} {ops_per_byte:>7.1}  {verdict}", secs * 1e6);
    }
