...
```
$ test -s hawking-experiments/superwave/g1/g1-traffic-anatomy.md && echo OK
OK
```

```
$ wc -l hawking-experiments/superwave/g1/g1-traffic-anatomy.md
     594 hawking-experiments/superwave/g1/g1-traffic-anatomy.md
```

```
$ git status --porcelain
?? hawking-experiments/superwave/g1/g1-traffic-anatomy.md
```
...
CHANGES:
- created `hawking-experiments/superwave/g1/g1-traffic-anatomy.md` only

TESTS:
- `test -s hawking-experiments/superwave/g1/g1-traffic-anatomy.md`
- `wc -l hawking-experiments/superwave/g1/g1-traffic-anatomy.md`
- `git status --porcelain`
