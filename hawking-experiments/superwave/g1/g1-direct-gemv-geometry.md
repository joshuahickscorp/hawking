...
This worktree's `hawking-experiments/superwave/g1/` contains only `README.md`
...
CHANGES
- created `hawking-experiments/superwave/g1/g1-direct-gemv-geometry.md` only

TESTS
- `test -s hawking-experiments/superwave/g1/g1-direct-gemv-geometry.md` (run at lane end)
- `wc -l hawking-experiments/superwave/g1/g1-direct-gemv-geometry.md` (run at lane end)
