...
- Frankenstein `*.pt` / `*.npz` under `hawking-experiments/frankenstein/data` — GLM/other campaign, not Qwen3.8 G0.
...
CHANGES
Created hawking-experiments/superwave/g1/g1-artifact-inventory.md only.

TESTS
```
$ test -s hawking-experiments/superwave/g1/g1-artifact-inventory.md && echo 'test -s: PASS'
test -s: PASS
$ wc -l hawking-experiments/superwave/g1/g1-artifact-inventory.md
     448 hawking-experiments/superwave/g1/g1-artifact-inventory.md
$ git status --porcelain
?? hawking-experiments/superwave/g1/g1-artifact-inventory.md
```
