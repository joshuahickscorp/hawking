...
```
$ test -s hawking-experiments/superwave/g1/g1-byte-deletions.md && echo OK
OK
```

```
$ wc -l hawking-experiments/superwave/g1/g1-byte-deletions.md
     764 hawking-experiments/superwave/g1/g1-byte-deletions.md
```

```
$ git status --porcelain
?? hawking-experiments/superwave/g1/g1-byte-deletions.md
```
...
CHANGES:
- created `hawking-experiments/superwave/g1/g1-byte-deletions.md` only

TESTS:
- `test -s hawking-experiments/superwave/g1/g1-byte-deletions.md`
- `wc -l hawking-experiments/superwave/g1/g1-byte-deletions.md`
- `git status --porcelain`
