...
```
$ test -s hawking-experiments/superwave/g1/g1-bit-budget-accounting.md && echo PASS
PASS

$ wc -l hawking-experiments/superwave/g1/g1-bit-budget-accounting.md
     591 hawking-experiments/superwave/g1/g1-bit-budget-accounting.md

$ git status --porcelain
?? hawking-experiments/superwave/g1/g1-bit-budget-accounting.md
```
...
CHANGES
created hawking-experiments/superwave/g1/g1-bit-budget-accounting.md
no tracked file modified

TESTS
test -s hawking-experiments/superwave/g1/g1-bit-budget-accounting.md
wc -l hawking-experiments/superwave/g1/g1-bit-budget-accounting.md
git status --porcelain
