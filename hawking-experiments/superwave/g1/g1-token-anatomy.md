...
```
$ test -s hawking-experiments/superwave/g1/g1-token-anatomy.md && echo PASS
PASS
```

```
$ wc -l hawking-experiments/superwave/g1/g1-token-anatomy.md
     515 hawking-experiments/superwave/g1/g1-token-anatomy.md
```

```
$ git status --porcelain
?? hawking-experiments/superwave/g1/g1-token-anatomy.md
```
...
CHANGES
created hawking-experiments/superwave/g1/g1-token-anatomy.md
no tracked file modified
no GPU / inference / live Genesis touch

TESTS
test -s hawking-experiments/superwave/g1/g1-token-anatomy.md → PASS
wc -l hawking-experiments/superwave/g1/g1-token-anatomy.md → 515
git status --porcelain → ?? hawking-experiments/superwave/g1/g1-token-anatomy.md
