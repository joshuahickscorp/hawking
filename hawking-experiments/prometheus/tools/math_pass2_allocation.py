...
Resolves the thing `hawking-experiments/prometheus/config/math-v1.json` has stood stubbed for since
...
completeness unless every sparse layer the source declares has capsule evidence.
    ...
    python3.12 hawking-experiments/prometheus/tools/math_pass2_allocation.py preview
    python3.12 hawking-experiments/prometheus/tools/math_pass2_allocation.py freeze --out PROMETHEUS_MATH_ALLOCATION_MANIFEST.json
    python3.12 hawking-experiments/prometheus/tools/math_pass2_allocation.py selftest
"""
