...
whether `<Base>-H0.98-Math-Preserve.gravity` is sealable.
    ...
    python3.12 hawking-experiments/prometheus/tools/math_pass3_pack.py status
    python3.12 hawking-experiments/prometheus/tools/math_pass3_pack.py run [--limit-shards N]
"""
