...
lower-confidence supplementary evidence, not the reverse.
    ...
    python3.12 hawking-experiments/prometheus/tools/math_pass1_cartography.py run [--windows N]
    python3.12 hawking-experiments/prometheus/tools/math_pass1_cartography.py status
    python3.12 hawking-experiments/prometheus/tools/math_pass1_cartography.py selftest
"""
