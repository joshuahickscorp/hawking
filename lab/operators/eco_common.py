"""Recomposed science module eco_common (C-SCI-R1)."""
...
__all__ = ['EcoError', 'SCHEMA_PASSPORT', 'SCHEMA_IDENTITY_EDGE', 'SCHEMA_PRIOR_LEDGER', 'SCHEMA_ADAPTIVE_PLAN', 'SCHEMA_PIPELINE', 'SCHEMA_PIPELINE_STATE', 'SCHEMA_ACTIVATION', 'SCHEMA_ACTIVATION_MANIFEST', 'SCHEMA_ADMISSION_PLAN', 'SCHEMA_STATUS', 'CAMPAIGN_PLAN_SHA256', 'repo_root', 'now_iso', 'canonical_bytes', 'hash_value', 'sealed', 'seal_field', 'is_sha256', 'read_json_safe', 'sha_file', 'atomic_write_json', 'eco_state_root']
