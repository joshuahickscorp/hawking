...
from frankenstein_ablation import (
    DEFAULT_SECONDARY_TOLERANCE,
    audit_contamination,
    audit_teacher_memorization,
    run_independent_challenger,
)
from frankenstein_baseline_freeze import freeze_base_dsv4f_baseline
from frankenstein_bridges import V0_MODULE_NAMES as BRIDGE_V0_MODULES
from frankenstein_fusion_op import DEEPSEEK_V4_FLASH, GLM_5_2
from frankenstein_gates import (
...
from frankenstein_promotion_gate import evaluate_promotion
from frankenstein_receipts import (
...
EVIDENCE_ROOT = REPO_ROOT / "hawking-experiments" / "frankenstein" / "data"
...
def independent_verify(
    *,
    ...
    from frankenstein_latent_v0 import retention_gate
...
def build_cloud_package(
    *,
    ...
    restore_cmd = (
        f"python3.12 hawking-experiments/frankenstein/operators/frankenstein_v0_seal.py restore "
...
python3.12 hawking-experiments/frankenstein/operators/frankenstein_v0_seal.py restore \\
  --package "$SCRIPT_DIR" \\
  --out "$OUT_DIR"
...
This package does NOT upload itself. A human must:
  ...
  3. Confirm with the local hook (so reclaim can read PROTO_CLOUD_SEALED):
       ...
       python3.12 hawking-experiments/frankenstein/operators/frankenstein_v0_seal.py confirm-cloud \\
         --package {pkg_dir} \\
