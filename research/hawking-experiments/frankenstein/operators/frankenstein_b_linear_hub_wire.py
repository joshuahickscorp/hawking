...
import frankenstein_adapter_hub as hub
...
DEFAULT_EVIDENCE_OUT = (
    REPO_ROOT / "hawking-experiments" / "frankenstein" / "data" / "proto-v0-desktop-artifact"
)
    ...
    *,
    ...
    receipt = {
        ...
        "load_instructions": {
            ...
            "with_repo": (
                "python hawking-experiments/frankenstein/operators/frankenstein_b_linear_hub_wire.py "
