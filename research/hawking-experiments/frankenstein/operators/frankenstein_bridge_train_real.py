...
import frankenstein_ablation as ablation
import frankenstein_adapter_trainer as adapter_trainer
import frankenstein_latent_v0 as latent_v0
from frankenstein_bridges import V0_BRIDGE_SITES
from frankenstein_correspondence_loader import (
    load_dsv4f_from_receipts,
    load_glm_layer_matrix,
    load_paired_activations,
    parse_layer_range,
)
from frankenstein_fusion_op import (
    BRIDGES,
    DEEPSEEK_V4_FLASH,
    GLM_5_2,
...
def try_load_real_pairs(
    *,
    ...
    if not paired.report.ok:
        ...
        from frankenstein_correspondence_loader import LoadReport
...
def _train_one_real_arm_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    import frankenstein_latent_v0 as lv
