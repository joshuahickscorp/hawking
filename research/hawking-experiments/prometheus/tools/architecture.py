...
allocation plan would be assuming the result.
    ...
    python3.12 hawking-experiments/prometheus/tools/architecture.py --profile math-v1
    python3.12 hawking-experiments/prometheus/tools/architecture.py --selftest
"""
...
from lab.layout import PROMETHEUS_CONFIG_ROOT, evidence_dir, resolve_workspace_path  # noqa: E402

import prometheus as spine  # noqa: E402

GLM52_EVIDENCE = evidence_dir("glm52")
PROFILE_DIR = PROMETHEUS_CONFIG_ROOT
