...
```
$ test -s hawking-experiments/superwave/g1/g1-addressing-topology.md && echo OK
OK
```

```
$ wc -l hawking-experiments/superwave/g1/g1-addressing-topology.md
     638 hawking-experiments/superwave/g1/g1-addressing-topology.md
```

```
$ git status --porcelain
?? hawking-experiments/superwave/g1/g1-addressing-topology.md
```
...
CHANGES:
- created `hawking-experiments/superwave/g1/g1-addressing-topology.md` only

TESTS:
- `test -s hawking-experiments/superwave/g1/g1-addressing-topology.md`
- `wc -l hawking-experiments/superwave/g1/g1-addressing-topology.md`
- `git status --porcelain`
