...
| `hawking-experiments/superwave/g1/g1-capture-harness.md` | this report |
...
```
$ test -s hawking-experiments/superwave/g1/g1-capture-harness.md; echo $?
0
```
...
?? tools/tests/
?? hawking-experiments/superwave/g1/g1-capture-harness.md
```
...
- hawking-experiments/superwave/g1/g1-doctor-recovery.md §5–§6
