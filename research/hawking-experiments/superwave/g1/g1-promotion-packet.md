...
- hawking-experiments/superwave/g1/g1-{capability-gate,tabula-genome,artifact-inventory,mlp-family-generate,q3-uniform-kernel,mlp-rolelock-unlock,baseline-remeasure,doctor-tensor-map,repack-recipe,recipe-v2,arch-negative}.md
- mixed-q3mlp-v1/{PACK_REPORT.json,FORMAT.md,catalog.hq38m20}

CHANGES
created hawking-experiments/superwave/g1/g1-promotion-packet.md only
