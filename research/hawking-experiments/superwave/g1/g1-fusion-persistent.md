...
CHANGES
- created `hawking-experiments/superwave/g1/g1-fusion-persistent.md` only

TESTS
- `test -s hawking-experiments/superwave/g1/g1-fusion-persistent.md` (required; run at end of this lane)
- `wc -l hawking-experiments/superwave/g1/g1-fusion-persistent.md` (required)
