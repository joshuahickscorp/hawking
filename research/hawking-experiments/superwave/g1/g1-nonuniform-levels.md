...
CHANGES
- Created `hawking-experiments/superwave/g1/g1-nonuniform-levels.md` (this file).
- No tracked file modified. No artifact packed. No process other than two CPU python workers (now exited).

TESTS
- `test -s hawking-experiments/superwave/g1/g1-nonuniform-levels.md` — see final-message TESTS
- `wc -l hawking-experiments/superwave/g1/g1-nonuniform-levels.md` — see final-message TESTS
