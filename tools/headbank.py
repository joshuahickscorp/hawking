...
-----
    ...
    python3 tools/headbank.py --manifest path/to/headbank_manifest.json --list

    # Stage a specific model
    python3 tools/headbank.py --manifest path/to/headbank_manifest.json --slug q3b

    # Stage a specific model and emit an env file to source
    python3 tools/headbank.py --manifest ... --slug q3b --env-file ~/.dismantle/env
