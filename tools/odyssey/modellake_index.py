    ...
    *,
    ...
    return {
        ...
        "stale_manifest_bytes_note": (
            "acquire() records du() allocated bytes including directories and "
            ".cache; the catalog sums st_size of regular files and skips .cache. "
            "A small negative delta is that difference, not a missing shard."
        ),
