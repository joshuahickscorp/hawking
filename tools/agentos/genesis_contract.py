...
CONTINUITY_RELATIVE_PATH = Path("docs/contracts/genesis/GENESIS_CONTINUITY_DIRECTIVE.md")
...
OUTPUT_LAW_RELATIVE_PATH = Path("docs/contracts/genesis/GENESIS_OUTPUT_LAW.md")
