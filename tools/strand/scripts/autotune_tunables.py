...
TUNABLES = [
    ...
    # ---------------- defined but DISABLED (documented, not run) ----------------
    {
        ...
        "default": 128,
        "direction": "min",
        "metric": "seconds/step of the KD loss chunk loop in strand-qat.py (KD_CHUNK constant)",
        "requires": ["tools/strand/scripts/strand-qat.py"],
    ...
    },
    {
        ...
        "requires": ["tools/strand/scripts/strand-7b-ppl.sh"],
        "cmd": None, "parse": None, "guard": None, "invariance": None,
    ...
    },
    {
        ...
        "direction": "min",
        "metric": "seconds per offload PPL eval per EVAL_GPU_GB on the pod",
        "requires": [],
        "cmd": None, "parse": None, "guard": None, "invariance": None,
