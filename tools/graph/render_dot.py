...
Usage:
    python3.12 tools/graph/render_dot.py --graph workspace/ops/build/graph/HAWKING_SEMANTIC_GRAPH.jsonl --out tools/graph/HAWKING_CRATE_GRAPH.dot
    python3.12 tools/graph/render_dot.py --graph fixture.jsonl --out /tmp/crates.dot --cluster-map workspace/ops/build/graph/HAWKING_CLUSTER_MAP.json
"""
