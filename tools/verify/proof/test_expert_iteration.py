...
from tools.verify.ramanujan_layout import FIXTURES_ROOT
from tools.verify.proof.base import (
    BackendStatus,
    VerificationRequest,
    Verdict,
)
from tools.verify.proof.exact_numeric import ExactNumericBackend, evaluate_exact
...
from tools.verify.proof.lean_backend import LeanBackend
from tools.verify.proof.registry import VerifierRegistry, probe_backends
...
class TeacherCritiqueGateTests(unittest.TestCase):
    def test_critique_requires_glm_access(self) -> None:
        ...
        from tools.verify.proof.base import VerificationResult
