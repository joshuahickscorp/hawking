"""CLI: probe backends and run the expert-iteration fixture end-to-end.
  ...
  python3 -m tools.verify.proof probe
  python3 -m tools.verify.proof fixture
"""
...
from tools.verify.proof.base import VerificationRequest, Verdict
from tools.verify.proof.expert_iteration import (
    ExpertIterationHarness,
    fixture_wrong_then_right_student,
)
from tools.verify.proof.registry import default_registry, probe_backends
