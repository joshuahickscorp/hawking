...
from tools.verify.proof.registry import VerifierRegistry, default_registry
from tools.verify.proof.trajectory import emit_paired_trace_record, emit_verified_trajectory
