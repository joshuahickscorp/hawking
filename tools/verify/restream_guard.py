...
from tools.verify.ramanujan_layout import BOUNDARY_ROOT, REPO_ROOT, resolve_ramanujan_path
...
def green_light_status_main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="python -m tools.verify.restream_guard")
    ...
    from tools.verify.ramanujan_boundary import local_status
