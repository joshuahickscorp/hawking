...
LINEAGE = REPO / "docs" / "roadmap-lineage" / "PRESERVATION.md"
...
Supersedes the 2026-09-02 H-ROADMAP snapshot, whose digest and provenance are
recorded under docs/roadmap-lineage/. The superseded bytes remain in Git history.
GENERATED by `python3 -m tools.roadmap.emit_revised`.
