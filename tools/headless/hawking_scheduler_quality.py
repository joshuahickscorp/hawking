#!/usr/bin/env python3
"""Measure Hawking ready-list ordering: critical-path vs ready_at vs as-shipped.

Run:
    python3 tools/headless/hawking_scheduler_quality.py
...
This file does not modify Hawking. Ordering arms other than
...
from hawking.resources import ResourceLimits  # noqa: E402
from hawking.scheduler import Scheduler  # noqa: E402
from hawking.workunit import WorkUnit, assign_ready, identify_ready  # noqa: E402

RECEIPT_PATH = REPO / "receipts" / "headless" / "HAWKING_SCHEDULER_QUALITY.json"
...
def main() -> int:
    ...
    head = git_head()
    started = utc_now()
    emit("=== Hawking scheduler quality ===")
    ...
    payload = {
        "schema": "hawking.headless.scheduler_quality.v1",
