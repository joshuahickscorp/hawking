...
Plain python3 + assert, and also importable under pytest.
    ...
    python3 tools/headless/hawking_max_isolation_test.py
"""
...
from hawking.mission import Mission  # noqa: E402
from hawking.workunit import WorkUnit  # noqa: E402
...
def check_grok_bridge_failure_isolation() -> None:
    ...
    import hawking.executors as executors
